...
This report tries to give insights into the implementation and refinement of the already existent presentation software \textit{rslidy}. It includes direct comparisons of the initial and the new version(s) in terms of design and functionality. Not only this contrast, but also the particular ways of implementing certain new features are listed and discussed.
